...
2. Standardized text fields (name casing, gender labels, city names)
3. Converted invalid entries to `NaN` and filled missing values using median/mode
4. Clipped out-of-range scores and attendance to a valid 0–100 range
5. Parsed and standardized inconsistent date formats
